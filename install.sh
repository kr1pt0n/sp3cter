...
# 2. Instalar el compilador de C# (Indispensable para generar el beacon)
echo -e "${GREEN}[+] Instalar Mono Compiler (mcs)...${NC}"
sudo apt-get install mono-mcs -y

# 3. Instalar librerías de Python usando APT (Evita errores de pip en Kali)
...
# 4. Asegurar permisos de ejecución para el C2
